1)  This demo uses terragrunt to wrap terraform, to setup terragrunt you will need to edit the standard terragrunt.hcl files to reflect your AWS account, region and profile.
