...
inputs = {
  ...
  assumable_roles = [
    "arn:aws:iam::812281370481:role/${local.name}", # on-nonprod
    "arn:aws:iam::304674821297:role/${local.name}", # in-nonprod
    "arn:aws:iam::516357051515:role/${local.name}", # on-prod
    "arn:aws:iam::023932916467:role/${local.name}", # in-prod
  ]
